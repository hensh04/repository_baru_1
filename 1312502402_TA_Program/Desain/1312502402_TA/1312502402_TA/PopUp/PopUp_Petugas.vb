Public Class PopUp_Petugas
    ...
    Sub isiListView(Optional ByVal kriteria As String = "%")
        ...
        For baris As Integer = 0 To xList.Count - 1
            ...
            ListViewPetugas.Items(baris).SubItems.Add(xList.Item(baris).ppass)
        Next
    End Sub
    ...
    Sub PilihBarisView()
        ...
        rpass = ListViewPetugas.FocusedItem.SubItems(6).Text
        Me.Dispose()
    End Sub
    ...
    Private Sub ListViewPetugas_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles ListViewPetugas.SelectedIndexChanged
