...
Public Class PopUp_Pendaftaran
    ...
    Sub isiListView(Optional ByVal kriteria As String = "%")
        ...
        For baris As Integer = 0 To xList.Count - 1
            ...
            If objpasien.cari = True Then
                ...
                ListViewPendaftaran.Items(baris).SubItems.Add(objpasien.pusia)
            End If
    ...
    Sub PilihBarisView()
        ...
        rusia = ListViewPendaftaran.FocusedItem.SubItems(5).Text
        rkd_dokter = ListViewPendaftaran.FocusedItem.SubItems(6).Text
        rnm_dokter = ListViewPendaftaran.FocusedItem.SubItems(7).Text
        rbiaya_dokter = ListViewPendaftaran.FocusedItem.SubItems(8).Text
        rbiaya_daftar = ListViewPendaftaran.FocusedItem.SubItems(9).Text
        rkd_petugas = ListViewPendaftaran.FocusedItem.SubItems(10).Text
        Me.Close()
    End Sub
