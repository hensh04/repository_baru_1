...
Public Class CRKwintansi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_1312502402_TA.CRKwintansi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NomorKwitansi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRKwintansi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRKwintansi = New CRKwintansi()
        rpt.Site = Me.Site
        Return rpt
    End Function
