...
Public Class CLPendapatan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_1312502402_TA.CLPendapatan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCLPendapatan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CLPendapatan = New CLPendapatan()
        rpt.Site = Me.Site
        Return rpt
    End Function
