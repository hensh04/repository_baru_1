...
INSERT INTO `petugas` VALUES ('PTG001','Wawan','1965-05-17','Pria','Jl.Bojongsari','085214597845'),('PTG002','hendri','2010-02-02','Pria','sawangan','087747548574');
...
CREATE DEFINER='root'@'localhost' TRIGGER `PenguranganStock` AFTER INSERT ON `detil_nota`
