...
Public Class Cetak_nota
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        For n = 0 To ListViewNota.Items.Count - 1
            If ListViewNota.Items(n).Text = txtKdObat.Text Then
                MsgBox("Data obat masuk ada pada list")
                Exit Sub
            End If
        Next
        ...
        If txtJmlObat.Text = "" Or txtJmlObat.Text = "0" Or txtAturanPakai.Text = "" Or txtAturanPakai.Text = "0" Then
    ...
    Private Sub btnHapus_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHapus.Click
        ...
        If hapus = Windows.Forms.DialogResult.OK Then
            If ListViewNota.SelectedItems.Count = 1 Then
                With ListViewNota.SelectedItems.Item(0)
                    ListViewNota.SelectedItems(0).Remove()
                End With
            Else
                MsgBox("Tidak ada data yang dipilih", MsgBoxStyle.Information, "Peringatan")
            End If
        End If
        txtTotal.Text = Format(CDbl(asubtotal()), " ###,###,###")
    End Sub
