...
Public Class test_surat_sakit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_1312502402_TA.test_surat_sakit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtest_surat_sakit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As test_surat_sakit = New test_surat_sakit()
        rpt.Site = Me.Site
        Return rpt
    End Function
