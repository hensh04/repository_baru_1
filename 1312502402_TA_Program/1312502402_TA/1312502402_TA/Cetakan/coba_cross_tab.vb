...
Public Class coba_cross_tab
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_1312502402_TA.coba_cross_tab.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcoba_cross_tab
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As coba_cross_tab = New coba_cross_tab()
        rpt.Site = Me.Site
        Return rpt
    End Function
